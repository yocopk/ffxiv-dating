...
export default function NewsTab() {
  return (
    <div className="bg-gray-100 px-4 lg:px-52 py-16 flex justify-center">
      <div className="flex items-center flex-col lg:flex-row">
        <img
          className="rounded-lg md:max-w-[500px] border-4 border-white"
